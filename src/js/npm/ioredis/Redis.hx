package js.npm.ioredis;
import js.npm.redis.RedisClient;
import haxe.DynamicAccess;

@:jsRequire("ioredis")
extern class Redis extends js.npm.redis.RedisClient {
  @:overload(function(options:RedisOptions):Void {})
  @:overload(function(unix_socket:String, options:RedisOptions):Void {})
  @:overload(function(redis_url:String, options:RedisOptions):Void {})
  @:overload(function(port:Int, host:String, options:RedisOptions):Void {})
